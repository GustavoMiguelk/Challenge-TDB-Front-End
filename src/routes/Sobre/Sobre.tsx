        ...
        <section className="flex flex-col md:flex-row-reverse gap-8 items-center">
         ...
         <section className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">Nossa equipe utilizou HTML para colocar as informações do nosso site, CSS para o visual e JavaScript para o funcionamento do site.</p>
          </div>
        </section>
        <section className="flex flex-col md:flex-row-reverse gap-8 items-center">
          <div className="flex-1">
